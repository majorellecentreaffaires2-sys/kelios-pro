...
router.post('/register', async (req, res) => {
    ...
    try {
        ...
        // En développement, afficher le code dans la console au lieu d'envoyer un email
            ...
            try {
                ...
                <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 30px; border: 1px solid #f1f5f9; border-radius: 20px; background: #ffffff;">
                  ...
                  <div style="text-align: center; margin-top: 30px;">
                    <a href="https://majorlle.pro" style="display: inline-block; background: #2563eb; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: 600;">Accéder à l'application</a>
                  </div>
                </div>
                `
                };
                ...
                // En cas d'échec d'email, continuer quand même
                console.log(`🔍 Code de vérification (fallback) pour ${email}: ${verificationCode}`);
            }
        }
